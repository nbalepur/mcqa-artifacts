...
def run_inference(dataset_names, model_name, partition, use_random_question, use_20_fewshot, pipe, tokenizer, prompt_dir, res_dir, ds_dir):
...
if __name__ == '__main__':
    ...
    # run inference
    run_inference(dataset_names, model_name, half, use_random_question, use_20_fewshot, pipe, tokenizer, prompt_dir, res_dir, ds_dir)
